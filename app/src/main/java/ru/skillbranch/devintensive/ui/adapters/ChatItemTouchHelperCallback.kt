...
class ChatItemTouchHelperCallback(private val chatAdapter : ChatAdapter, private val swipeListener: (ChatItem) -> Unit) : ItemTouchHelper.Callback() {
    ...
    override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
        swipeListener.invoke(chatAdapter.items[viewHolder.adapterPosition])
    }
